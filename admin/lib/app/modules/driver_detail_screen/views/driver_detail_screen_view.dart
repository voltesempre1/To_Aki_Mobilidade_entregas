                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  rowDataWidget(
                                                      name: "Name",
                                                      value: controller.driverUserModel.value.fullName.toString(),
                                                  ...
                                                  rowDataWidget(
                                                      name: "Gender",
                                                      value: controller.driverUserModel.value.gender.toString(),
                                                      themeChange: themeChange),
                                                ],
                                              ),
                                            ).expand(),
                                            spaceW(width: 20),
                                            if (controller.driverUserModel.value.driverVehicleDetails != null)
                                              Container(
                                                padding: paddingEdgeInsets(horizontal: 20, vertical: 20),
                                                decoration: BoxDecoration(
                                                  color: themeChange.isDarkTheme() ? AppThemData.greyShade950 : AppThemData.greyShade50,
                                                      ...
                                                      Expanded(
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            FittedBox(
                                                              child: Text(
                                                                Constant.amountShow(amount: controller.driverUserModel.value.walletAmount!),
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            rowDataWidget(
                                                                name: "Vehicle Number",
                                                                value:
                                                                    controller.driverUserModel.value.driverVehicleDetails!.vehicleNumber.toString(),
                                                                themeChange: themeChange),
                                                            spaceH(height: 10),
                                                            rowDataWidget(
                                                                name: "Vehicle Type Name",
                                                                value:
                                                                    controller.driverUserModel.value.driverVehicleDetails!.vehicleTypeName.toString(),
                                                                themeChange: themeChange),
                                                          ],
                                                        ),
                                                      ).expand(),
                                          ...
                                          SizedBox(
                                            ...
                                            child: Obx(
                                              () => DropdownButtonFormField(
                                                ...
                                                value:
                                                    controller.selectedPayoutStatus.value.isNotEmpty ? controller.selectedPayoutStatus.value : "All",
