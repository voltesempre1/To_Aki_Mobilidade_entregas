const Map<String, String> hiIN = {
  ...
  "You signed up using Google or Apple. Password changes are not available for social login accounts.": "आपने Google या Apple का उपयोग करके साइन अप किया है। सोशल लॉगिन खातों के लिए पासवर्ड बदलना उपलब्ध नहीं है।",
  "Security": "सुरक्षा",
  ...
  "Enter your email address and we'll send you a password reset link": "अपना ईमेल पता दर्ज करें और हम आपको पासवर्ड रीसेट लिंक भेजेंगे",
