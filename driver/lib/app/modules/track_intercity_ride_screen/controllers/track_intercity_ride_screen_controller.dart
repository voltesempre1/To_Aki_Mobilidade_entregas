...
class TrackInterCityRideScreenController extends GetxController {
  ...
  Future<void> getArgument() async {
    ...
    if (argumentData != null) {
      ...
      log("---------------------------> ${intercityModel.value.toJson()}");
      FirebaseFirestore.instance.collection(CollectionName.interCityRide).doc(intercityModel.value.id).snapshots().listen((bookingEvent) {
        if (bookingEvent.data() != null) {
          ...
          intercityModel.value = updatedBooking;

          FirebaseFirestore.instance
              .collection(CollectionName.drivers)
              .doc(intercityModel.value.driverId)
              .snapshots()
            ...
            if (driverEvent.data() != null) {
              ...
              if (lastDriverLocation == null ||
                  ...
                  lastBookingStatus != intercityModel.value.bookingStatus) {
              ...
              lastBookingStatus = intercityModel.value.bookingStatus.toString();
