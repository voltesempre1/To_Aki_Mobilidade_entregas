                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //         Obx(
                          //               () => Text(
                          //             controller.selectedDateRangeForPdf.value.start == DateTime(DateTime.now().year, DateTime.january, 1) && controller.selectedDateRangeForPdf.value.end == DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, 23, 59, 0, 0)
                          //                 ? "Select Date".tr
                          //                 : "${DateFormat('dd/MM/yyyy').format(controller.selectedDateRangeForPdf.value.start)} to ${DateFormat('dd/MM/yyyy').format(controller.selectedDateRangeForPdf.value.end)}",
                          //             style: GoogleFonts.inter(
                          //               color: themeChange.isDarkTheme() ? AppThemData.white : AppThemData.grey950,
