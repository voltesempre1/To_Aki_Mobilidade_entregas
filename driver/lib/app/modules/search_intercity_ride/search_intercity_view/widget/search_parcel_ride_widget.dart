                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: GooglePlaceAutoCompleteTextFieldOnlyCity(
                            ...
                            clearData: () {
                              if (index == 0) {
                                ...
                                controller.parcelPickUpAddress.value = '';
                                ...
                                controller.parcelDropAddress.value = '';
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Obx(
                                  () => Text(
                                    controller.selectedParcelDate.value == null
                                        ? "Select Date".tr
                                        : controller.selectedParcelDate.value!.dateMonthYear(),
                                    style: GoogleFonts.inter(
                                      color: themeChange.isDarkTheme() ? AppThemData.white : AppThemData.grey950,
                                      fontSize: 16,
                    ...
                    RoundShapeButton(
                      ...
                      onTap: () async {
                        controller.parcelPickUpAddress.value = controller.pickupLocationController.value.text;
                        log("Pickup address :: ${controller.parcelPickUpAddress.value}");

                        if (controller.parcelPickUpAddress.value == '') {
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          const SizedBox(height: 12),
                                          PickDropPointView(
                                              pickUpAddress: parcelModel.pickUpLocationAddress ?? '',
                                              dropAddress: parcelModel.dropLocationAddress ?? ''),
                                          const SizedBox(height: 16),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                                                            ...
                                                                            FireStoreUtils.setParcelBooking(parcelModel).then((value) async {
                                                                              if (value == true) {
                                                                                ...
                                                                                UserModel? receiverUserModel = await FireStoreUtils.getUserProfile(
                                                                                    parcelModel.customerId.toString());
                                                                    ...
                                                                    builder: (context) {
                                                                      return CustomDialogBox(
                                                                          ...
                                                                          positiveClick: () async {
                                                                            ...
                                                                            parcelModel.driverVehicleDetails =
                                                                                Constant.userModel!.driverVehicleDetails;
                                                                            parcelModel.vehicleType = vehicleModel;
                                                                            ...
                                                                            FireStoreUtils.setParcelBooking(parcelModel).then((value) async {
                                                                              if (value == true) {
                                                                                ...
                                                                                await SendNotification.sendOneNotification(
                                                                                    ...
                                                                                    driverId: parcelModel.driverId.toString(),
                                                                                    body:
                                                                                        'Your Parcel #${parcelModel.id.toString().substring(0, 5)} has been confirmed.',
                                                                                    payload: playLoad);
                                                                                Navigator.pop(context);
                                                                              } else {
                                                                            ...
                                                                            FireStoreUtils.setParcelBooking(parcelModel).then((value) async {
                                                                              if (value == true) {
                                                                                ...
                                                                                await SendNotification.sendOneNotification(
                                                                                    ...
                                                                                    driverId: parcelModel.driverId.toString(),
                                                                                    body:
                                                                                        'Your ride #${parcelModel.id.toString().substring(0, 5)} has been Rejected by Driver.',
                                                                                    // body: 'Your ride has been rejected by ${driverModel!.fullName}.',
                                                                                    payload: playLoad);
