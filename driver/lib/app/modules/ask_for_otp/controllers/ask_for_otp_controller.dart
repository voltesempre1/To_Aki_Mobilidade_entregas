...
class AskForOtpController extends GetxController {
  ...
  void getPolyline({required double? sourceLatitude, required double? sourceLongitude, required double? destinationLatitude, required double? destinationLongitude}) async {
    if (sourceLatitude != null && sourceLongitude != null && destinationLatitude != null && destinationLongitude != null) {
      ...
      addMarker(latitude: bookingModel.value.pickUpLocation!.latitude, longitude: bookingModel.value.pickUpLocation!.longitude, id: "Departure", descriptor: departureIcon!, rotation: 0.0);
      addMarker(latitude: bookingModel.value.dropLocation!.latitude, longitude: bookingModel.value.dropLocation!.longitude, id: "Destination", descriptor: destinationIcon!, rotation: 0.0);
      addMarker(
